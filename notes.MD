...
--BROWSERIFY--
# Browserify is responsible for translating "require" and "exports" keywords provided by Node to the browser.  Otherwise the browser wouln't recognize the keywords.
